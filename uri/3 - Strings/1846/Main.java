...
public class Main {
    ...
    static String numbers[] = {"zero", "um", "dois", "tres", "quatro", "cinco", "seis", "sete", "oito", "nove", "dez"};
    ...
    static String numberToWords(long number) {
        ...
        if ((number / 10000000) > 0) {
            words += numberToWords(number / 10000000) + " dez milhões ";
            number %= 10000000;
        }
        if ((number / 100000) > 0) {
            words += numberToWords(number / 100000) + " cem mil ";
            number %= 100000;
        }
        if ((number / 1000) > 0) {
...
// definindo o extenso dos centavos do valor
  ...
  public static void main(String[] args) {
    ...
    while(scanner.hasNext()){
        System.out.println(valorPorExtenso(scanner.nextInt()));
    }
