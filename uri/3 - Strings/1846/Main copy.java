...
class dExtenso {
   ...
   private boolean trio_a_esquerda_eq_zero(String[] vetorTrios, int contador) {
    ...
    public String getExtenso(Integer numero) {
        return getExtenso(numero.toString());
    }
...
//                        saida = ", " + saida;
        ...
        // ajuste
        if(extensoFinal.indexOf("um mil")!=-1)
            extensoFinal = extensoFinal.replaceAll("^um mil", "mil");
...
class Main{
    ...
    public static void main(String [] args){
        ...
        while(scanner.hasNext()){
           System.out.println(e.getExtenso(scanner.nextInt()));
        }
